    ...
    def _from_pretrained(cls, pretrained_model_name_or_path, *init_inputs, **kwargs):
        ...
        try:
            if(pretrained_model_name_or_path=='gpt2'):
                resolved_vocab_files = {'vocab_file':'models/gpt-2/vocab_file','merges_file':'models/gpt-2/merges_file'}
            elif(pretrained_model_name_or_path=='ctrl'):
                resolved_vocab_files = {'vocab_file':'models/ctrl/ctrl-vocab.json','merges_file':'models/ctrl/ctrl-merges.txt'}
            else:
                msg = "Couldn't get vocab.json or merges.txt."
        ...
        for file_id, file_path in vocab_files.items():
            if file_path == resolved_vocab_files[file_id]:
                ...
                logger.info("loading file from cache at {}".format(resolved_vocab_files[file_id]))
