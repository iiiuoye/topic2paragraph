    ...
    def get_config_dict(cls, pretrained_model_name_or_path: str, **kwargs) -> Tuple[Dict, Dict]:
        ...
        try:
            ...
            if(pretrained_model_name_or_path=='gpt2'):
                resolved_config_file = "models/gpt-2/gpt2Config"
            elif(pretrained_model_name_or_path=='ctrl'):
                resolved_config_file = "models/ctrl/ctrlConfig"
            else:
                msg = "Couldn't get config file."
        ...
        if resolved_config_file == config_file:
            ...
            logger.info("loading configuration file from cache at {}".format(resolved_config_file))
