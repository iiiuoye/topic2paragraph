        ...
        if pretrained_model_name_or_path is not None:
            ...
            try:
                ...
                if(pretrained_model_name_or_path=='gpt2'):
                    # """/home/generator/Development/gpt-2/checkpoint/kaggle_news_small/model-96000.data-00000-of-00001"""
                    resolved_archive_file = 'models/gpt-2/model-94000.index'
                elif(pretrained_model_name_or_path=='ctrl'):
                    resolved_archive_file = 'models/ctrl/a0cbbf992392951fa27507d3627b2abd63eec70881a0ef7f01047de09999a838.c60964e4bc94b436f4f84975b562d62efbdef44e8bf521e9bda9fe7c53f9541b'
                else:
                    msg = "Couldn't get model file."
            ...
            if resolved_archive_file == archive_file:
                ...
                logger.info("loading weights file from cache at {}".format(resolved_archive_file))
        else:
